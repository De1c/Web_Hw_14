...
class TestContacts(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_update_contact(self):
        ...
        contact = Contact(id=contact_id, name="Sasha", surname="Pan", email="sashapan@example.com", phone="0987654321",
    ...
    async def test_searcher(self):
        contact1 = Contact(name='Masha', surname='Iva', email='masha.iva@example.com')
        contact2 = Contact(name='Sasha', surname='Iva', email='sasha.iva@example.com')
        contact3 = Contact(name='Vanya', surname='Ukr', email='vanya.ukr@example.com')
        self.session.query.return_value.all.return_value = [contact1, contact2, contact3]
        results = await searcher('Iva', self.session)
